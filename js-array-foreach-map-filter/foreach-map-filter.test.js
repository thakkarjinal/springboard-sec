fdescribe("#doubleValues", function() {
...
fdescribe("#addKeyAndValue", function() {
...
fdescribe("#doubleValuesWithMap", function() {
  it("doubles values in an array", function() {
...
fdescribe("#valTimesIndex", function() {
...
fdescribe("#extractFulName", function() {
  var arr = [
...
fdescribe("#filterByValue", function() {
  var arr = [
    { first: "Elie", last: "Schoppik" },
...
fdescribe("#removeVowels", function() {
...
fdescribe("#doubleOddNumbers", function() {
